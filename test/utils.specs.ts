...
import { encryptAllowance, decryptAllowance, MAXIMUM_ALLOWANCE  } from "../src/utils/encryption";
...
describe("Utils", function () {
  ...
  it("Should encrypt and decrypt MaxUint256", async function () {           
      expect(function(){encryptValue(ethers.constants.MaxUint256.toBigInt())}).to.throw(Error);
  })
})