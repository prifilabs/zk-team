...
class ZkTeamCore extends sdk_1.BaseAccountAPI {
    ...
    createProvedUserOp(info) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { proof, publicSignals } = yield snarkjs_1.groth16.fullProve(inputs, "ptau-data/ZkTeam_js/ZkTeam.wasm", "ptau-data/ZkTeam_0001.zkey");
            const vKey = JSON.parse((0, fs_1.readFileSync)("ptau-data/verification_key.json").toString());
            let res = yield snarkjs_1.groth16.verify(vKey, publicSignals, proof);
            if (!res)
